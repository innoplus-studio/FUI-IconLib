	...
	switch (props.name) {
		case FIconNames.ADD:
			return size === "large" ? (
				<>
					<path
						d="M12 5V19"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
		...
		case FIconNames.AWARD:
			return size === "large" ? (
				...
				<>
					<path
						d="M7.99998 10C10.5773 10 12.6666 7.91066 12.6666 5.33333C12.6666 2.756 10.5773 0.666664 7.99998 0.666664C5.42265 0.666664 3.33331 2.756 3.33331 5.33333C3.33331 7.91066 5.42265 10 7.99998 10Z"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
					<path
						d="M5.47335 9.26L4.66669 15.3333L8.00002 13.3333L11.3334 15.3333L10.5267 9.25333"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
		...
		case FIconNames.BOOK:
			return size === "large" ? (
				...
				<>
					<path
						d="M2.66669 13C2.66669 12.558 2.84228 12.1341 3.15484 11.8215C3.4674 11.5089 3.89133 11.3333 4.33335 11.3333H13.3334"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
					<path
						d="M4.33335 1.33334H13.3334V14.6667H4.33335C3.89133 14.6667 3.4674 14.4911 3.15484 14.1785C2.84228 13.866 2.66669 13.442 2.66669 13V3C2.66669 2.55798 2.84228 2.13405 3.15484 1.82149C3.4674 1.50893 3.89133 1.33334 4.33335 1.33334V1.33334Z"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
			...
			return size === "large" ? (
				<>
					<path
						...
						fill={props.fillColor ?? FColorTypes.FPrimaryColors.WHITE.LM}
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.6"}
						strokeLinecap="round"
						strokeLinejoin="round"
		...
		case FIconNames.GIFT:
			return size === "large" ? (
				...
				<>
					<path
						d="M13.3333 8V14.6667H2.66663V8"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
					<path
						d="M14.6667 4.66666H1.33337V8H14.6667V4.66666Z"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
					...
					/>
					<path
						d="M8.00004 4.66667H5.00004C4.55801 4.66667 4.13409 4.49107 3.82153 4.17851C3.50897 3.86595 3.33337 3.44203 3.33337 3C3.33337 2.55797 3.50897 2.13405 3.82153 1.82149C4.13409 1.50893 4.55801 1.33334 5.00004 1.33334C7.33337 1.33334 8.00004 4.66667 8.00004 4.66667Z"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
					<path
						d="M8 4.66667H11C11.442 4.66667 11.866 4.49107 12.1785 4.17851C12.4911 3.86595 12.6667 3.44203 12.6667 3C12.6667 2.55797 12.4911 2.13405 12.1785 1.82149C11.866 1.50893 11.442 1.33334 11 1.33334C8.66667 1.33334 8 4.66667 8 4.66667Z"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
		...
		case FIconNames.IMAGE:
			return size === "large" ? (
				...
				<>
					...
					/>
					<path
						d="M5.66667 6.66669C6.21896 6.66669 6.66667 6.21897 6.66667 5.66669C6.66667 5.1144 6.21896 4.66669 5.66667 4.66669C5.11439 4.66669 4.66667 5.1144 4.66667 5.66669C4.66667 6.21897 5.11439 6.66669 5.66667 6.66669Z"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
					<path
						d="M14 10L10.6667 6.66669L3.33333 14"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
		...
		case FIconNames.LEFT_ARROW:
			return size === "large" ? (
				...
				<>
					...
					/>
					<path
						d="M7.99998 12.6667L3.33331 8.00001L7.99998 3.33334"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
			...
			return size === "large" ? (
				<>
					<path
						...
						fill={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.6"}
						strokeLinecap="round"
						strokeLinejoin="round"
					...
					{size === "large" ? (
						<>
							<path
								...
								stroke={
									props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM
								}
								strokeWidth={props.strokeWidth ?? "1.6"}
								strokeLinecap="round"
								strokeLinejoin="round"
		...
		case FIconNames.USER:
			return size === "large" ? (
				...
				<>
					...
					/>
					<path
						d="M15.3334 14V12.6667C15.3329 12.0758 15.1363 11.5018 14.7743 11.0349C14.4123 10.5679 13.9055 10.2344 13.3334 10.0867"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
					<path
						d="M10.6666 2.08666C11.2402 2.23353 11.7487 2.56713 12.1117 3.03487C12.4748 3.50261 12.6719 4.07788 12.6719 4.67C12.6719 5.26211 12.4748 5.83738 12.1117 6.30512C11.7487 6.77286 11.2402 7.10646 10.6666 7.25333"
						stroke={props.strokeColor ?? FColorTypes.FPrimaryColors.BLACK.LM}
						strokeWidth={props.strokeWidth ?? "1.2"}
						strokeLinecap="round"
						strokeLinejoin="round"
